...
<!-- Page Content -->
    <div class="container">
        ...
        if(isset($_POST['submit']))
        {
            ...
            $sql = "SELECT * from blooddonors where (status=:status and BloodGroup=:bloodgroup) ||  (Address=:location)";
            $query = $dbh -> prepare($sql);
            ...
            <div>
                ...
                <div><p><strong>Please also read the <a href="page.php?type=aboutus">About Us</a> section for Guidelines on assessing donor suitability for blood donation.</strong></p>
                <h3>Blood Donation Benefits</h3>
                <p>Every 2 seconds, someone in the United States needs blood. Donating blood can help:</p>
                <ul>
                ...
                <br>
                Most of the location are based on City or District, so Try to Search Donors according to that.
